...
public class MainActivity extends AppCompatActivity {
    ...
    Button btnCheckStatus, btnSetStatus, btnUserLogout;
    TextView txtCafCount;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtCafCount = findViewById(R.id.txtCafCount);
        btnUserLogout = findViewById(R.id.btnUserLogout);

        btnCheckStatus.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent toCheckStatus = new Intent(MainActivity.this, CheckStatuses.class);
        ...
        btnSetStatus.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent toSetStatus = new Intent(MainActivity.this, UserScanSeat.class);
                startActivity(toSetStatus);
            }
        });

        final SharedPreferences shared = (getSharedPreferences ("MySharedPref", Context.MODE_PRIVATE));
        final SharedPreferences shared1 = (getSharedPreferences ("UserPrefs", Context.MODE_PRIVATE));
    ...
    public void computeCount(){
        ...
        txtCafCount.setText("Caf capacity: " + cafCapacity);
