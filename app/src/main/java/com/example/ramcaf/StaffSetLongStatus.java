...
public class StaffSetLongStatus extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_staff_set_long_status);

        statusListView = findViewById(R.id.longStatusList);
                    ...
                    try {
                        ...
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                adapter = new ArrayAdapter(StaffSetLongStatus.this, android.R.layout.simple_list_item_1, statusList);
                                ...
                                adapter = new ArrayAdapter(StaffSetLongStatus.this, R.layout.status_list_layout, statusList);
        ...
        statusListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                editStaffInfo.putString("tableType", "Long");
                editStaffInfo.commit();

                Intent toSetStatus = new Intent(StaffSetLongStatus.this, StaffDisinfect.class);
    ...
    public void fetchData() {
        try {
            ...
            Object result = new FetchLongDisinfectionStatus().execute ().get ();
            ...
            for (i = 0; i < ja.length (); i++) {
                ...
                String table_number = jo.getString ("long_table_number");
                String seat_number = jo.getString ("long_seat_number");
